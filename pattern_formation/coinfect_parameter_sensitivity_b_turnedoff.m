% coinfect parameter sensitivity when beta_10, beta_02, and beta_12 are
% turned off
...
beta_1=0.3; beta_2=0.5; beta_10=0; beta_02=0; beta_12=0;
gamma_1=0.02; gamma_2=0.05;
alpha_1=0.08; alpha_2=0.08; alpha_12=0.12;

dS=0.1; dSC=0;
dI=0.1; dJ=0.08; dC=0.5;
dIC=-0.2; dJC=-0.2;
dCI=0; dCJ=0;

dSI_vals=0.3:0.5:0.3;
dSJ_vals=-0.3:0.5:0.3;
...
for dSI=dSI_vals
    for dSJ=dSJ_vals
        ...
        axis equal tight;
        axis off;
        exportgraphics(figS, fullfile(output_folder, sprintf('S_dSI_%.2f_dSJ_%.2f.png', dSI, dSJ)), 'Resolution', 600);
        close(figS);
        ...
        axis equal tight;
        axis off;
        exportgraphics(figI, fullfile(output_folder, sprintf('I_dSI_%.2f_dSJ_%.2f.png', dSI, dSJ)), 'Resolution', 600);
        close(figI);
        ...
        axis equal tight;
        axis off;
        exportgraphics(figJ, fullfile(output_folder, sprintf('J_dSI_%.2f_dSJ_%.2f.png', dSI, dSJ)), 'Resolution', 600);
        close(figJ);
        ...
        axis equal tight;
        axis off;
        exportgraphics(figC, fullfile(output_folder, sprintf('C_dSI_%.2f_dSJ_%.2f.png', dSI, dSJ)), 'Resolution', 600);
        close(figC);
    end
end
